...
$header .= "From: Новая заявка <semenov.siberian@gmail.com>\n\n";	
$mail = mail("semenov.siberian@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
